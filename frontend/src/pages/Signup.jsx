        ...
        <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-bg-dark">
            ...
            >
                <div className="glass p-10 rounded-[32px] border border-white/10 shadow-2xl relative overflow-hidden">
                    {/* Glass Shine */}
                    <div className="absolute inset-0 bg-gradient-to-tl from-white/10 to-transparent opacity-50 pointer-events-none" />
                    ...
                    <div className="text-center mb-8 relative z-10">
                        <motion.div 
                            ...
                            className="w-16 h-16 bg-gradient-to-tr from-purple-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-purple-500/30"
                        >
                            <Camera className="text-white" size={32} />
                        </motion.div>
                        <h1 className="text-3xl font-extrabold text-white tracking-tight mb-2">Create Account</h1>
                        <p className="text-slate-400 text-sm font-medium">Join Drishyamitra to organize your memories</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-4 py-4 bg-slate-900/50 border border-white/5 rounded-2xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all font-medium"
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-4 py-4 bg-slate-900/50 border border-white/5 rounded-2xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white transition-all font-medium"
                                    placeholder="••••••••"
                                    minLength={6}
                                />
                            </div>
                        ...
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-purple-100 to-emerald-100 opacity-0 group-hover:opacity-100 transition-opacity" />
                    ...
                    <p className="text-center text-slate-400 text-sm font-medium mt-8 relative z-10">
                        ...
                        <Link to="/login" className="text-white font-bold hover:text-purple-400 transition-colors">Sign in</Link>
                    </p>
                </div>
            </motion.div>
        </div>
